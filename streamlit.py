...
"""
option = st.selectbox(
     'Which Levels to Look At?',
     ('B1+B2', 'B3+BC', 'I1+I2+IC'))

#B1+B2
st.write(f'Model running for {option}')
...
#B1 & B2
B1_df = textbook_df.loc[textbook_df['LEVEL_EXTRACT_3'].isin(level_list)]
